...
* Download any of the files above and unzip it. After unzipping, paste the contents inside of the beta folder. Make a backup of the original myhpbase.dll and delete/replace the original one. Delete version.dll
